        ...
        <div style={{ textAlign: 'right' }}>
          {c.rate && (
            <div style={{ marginBottom: '8px' }}>
              <div style={{  color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.04em', marginBottom: '4px' }}>Rate</div>
              ...
              <div style={{  color: 'var(--text-muted)' }}>/ SF / Mo {c.lease_type || ''}</div>
            </div>
          )}
      ...
      <div className="detail-grid">
        ...
        <div>
          ...
          <div className="detail-section">
            ...
            {!c.cam_psf && !c.insurance_psf && !c.tax_psf && !c.total_expenses_psf && (
              <div style={{  color: 'var(--text-muted)', fontStyle: 'italic' }}>No expense data recorded</div>
            )}
          </div>
        ...
        <div>
          ...
          <div className="card mb-4">
            <h4 style={{  fontWeight: 600, marginBottom: '14px' }}>Rate Summary</h4>
            ...
            {c.total_expenses_psf && c.rate && (
              <div style={{ marginTop: '16px', paddingTop: '14px', borderTop: '1px solid var(--border-subtle)' }}>
                <div style={{  color: 'var(--text-muted)', marginBottom: '8px', textTransform: 'uppercase', letterSpacing: '0.04em' }}>Cost Breakdown</div>
          ...
          {/* Building Info */}
          <div className="card mb-4">
            <h4 style={{  fontWeight: 600, marginBottom: '12px' }}>Building</h4>
            ...
            {!c.building_sf && !c.year_built && !c.clear_height && (
              <div style={{  color: 'var(--text-muted)', fontStyle: 'italic' }}>No building data</div>
            )}
          </div>
          ...
          {linkedProperty && (
            <div className="card mb-4">
              <h4 style={{  fontWeight: 600, marginBottom: '12px' }}>Linked Property</h4>
              <div style={{ padding: '10px', background: 'var(--bg-input)', borderRadius: '6px' }}>
                <div style={{  fontWeight: 500, color: 'var(--text-primary)' }}>{linkedProperty.address}</div>
          ...
          {/* Comp Metadata */}
          <div className="card">
            <h4 style={{  fontWeight: 600, marginBottom: '12px' }}>Comp Info</h4>
