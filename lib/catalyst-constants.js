...
export function getAllPropertyTagNames() { return PROPERTY_TAGS.map(t => t.tag); }
export function getAllCatalystTagNames() { return CATALYST_TAGS.map(t => t.tag); }
export function getAllTagNames() { return [...getAllPropertyTagNames(), ...getAllCatalystTagNames()]; }
