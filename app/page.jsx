...
export default function App() {
  ...
  const renderPage = () => {
    ...
    if (selectedProperty)  return <PropertyDetail  property={selectedProperty} onBack={() => setSelectedProperty(null)} onNavigate={navigate} onSelectAccount={openAccount} onConvertToDeal={handleConvertToDeal} deals={deals} leads={leads} contacts={contacts} leaseComps={leaseComps} saleComps={saleComps} onRefresh={loadAllData} toast={toast} onCatalystClick={tag => setSelectedCatalystTag(tag)} />;
