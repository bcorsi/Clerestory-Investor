...
export default function App() {
  ...
  const renderPage = () => {
    ...
    if (selectedProperty)  return <PropertyDetail  property={selectedProperty} onBack={() => setSelectedProperty(null)} onNavigate={navigate} onSelectAccount={openAccount} deals={deals} onRefresh={loadAllData} toast={toast} />;
    if (selectedDeal)      return <DealDetail      deal={selectedDeal} onBack={() => { setSelectedDeal(null); setPage('deals'); }} onNavigate={navigate} onSelectAccount={openAccount} onRefresh={loadAllData} toast={toast} />;
    if (selectedLead)      return <LeadDetail      lead={selectedLead} onBack={() => setSelectedLead(null)} onNavigate={navigate} onRefresh={loadAllData} toast={toast} />;
    ...
    switch (page) {
      ...
      case 'tasks':        return <Tasks           {...dataProps} onSelectTask={openTask} />;
      ...
      case 'comp-analytics': return <CompAnalytics  onNavigate={navigate} leaseComps={leaseComps} saleComps={saleComps} />;
      default:             return (
